...
find /mnt/data/datasets/shapenet/ShapeNetCore.v2/03211117 -name *.obj | head -n 2000 | xargs  -n1 -P4 -I {} blender --background --python render_blender.py -- --views 2 --output_folder /mnt/data/datasets/vignet/tvmonitor --cat tvmonitor {}
